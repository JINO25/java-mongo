...
public class Main {
    ...
    public static void menuUpdate(MongoDB mongoDB){
        ...
        boolean r = true;
        while(r){
            String name, email, major, date,address,phone, subject;
            double score;
            System.out.println("--------------------------------" +
                    ...
                    "5: Update all of information (name, major, date,address,phone)\n" +
            ...
            switch (number){
                ...
                case 1:
                    ...
                    mongoDB.updateUser(email, name, null, null, null, null, null, 0);
                    break;
                ...
                case 2:
                    ...
                    mongoDB.updateUser(email, null,null, date, null, null, null, 0);
                    break;
                ...
                case 3:
                    ...
                    mongoDB.updateUser(email, null,null, null, address, null, null, 0);
                    break;
                ...
                case 4:
                    ...
                    mongoDB.updateUser(email, null, null,null, null, phone, null, 0);
                    break;
                ...
                case 5:
                    ...
                    System.out.print("Enter new phone number: ");
                    phone = scanner.nextLine();
                    mongoDB.updateUser(email, name, major, date, address, phone, null, 0);
                    break;
                case 6:
                    System.out.print("Enter email to update: ");
                    email = scanner.nextLine();
                    ...
                    mongoDB.updateUser(email, null, null, null, null, null, subject, score);
                    break;
                case 7:
    ...
    public static void showMenu(Scanner scanner,MongoDB mongoDB){
        ...
        while(r){
            ...
            System.out.println("--------------------------------\n" +
                    ...
                    "3: Find a student based on email\n" +
                    "4: Update student (information, subjects and scores)\n" +
                    "5: Delete student\n" +
                    "0: Exit");
            int number = scanner.nextInt();
            scanner.nextLine();
